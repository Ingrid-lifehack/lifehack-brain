...
# bare `/*)` case below read `G:\Shared drives\AI BRAIN\...\brief.md` as RELATIVE and joined it onto
...
# like `/c/Repo/G:\Shared drives\...\brief.md`. That path can never exist, so every turn
